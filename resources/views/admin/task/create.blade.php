...
@section('content')
    ...
    <div class="row">
        <div class="main-title-00">
            ...
            @endif
            <a style="color: #fff;" href="{{route('home')}}">الرئيسية</a>
            <a style="color: #fff;" href="{{route('task.index')}}">/ المهمات / </a>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                ...
                {{Form::open(['method'=>'POST','action' => ['App\Http\Controllers\Admin\TaskController@store'], 'files' => true])}}
                    ...
                    <table class="table table-bordered table-striped">
                        <tbody>
                            ...
                            <tr>
                                <td> معين بواسطة</td>
                                <td>
                                    <select class="form-control" name="assigned_by_id">
