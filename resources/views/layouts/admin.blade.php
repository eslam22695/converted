    ...
    <div class="topbar">
        ...
        <div class="topbar-left">
            ...
            <div class="text-center">
                ...
                <a href="{{route('home')}}" class="logo" dir="rtl">
                    <i class="icon-c-logo"></i>
                    <span> 
                       لوحة تحكم موقع Converted
                    </span>
                </a>
        ...
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                ...
                <ul>
                    ...
                    <li><a href="{{route('home')}}" class="waves-effect"><i class="ti-home"></i> <span> الرئيسية </span></a></li>

                    <li><a href="{{route('task.index')}}" class="waves-effect"><i class="ion-ios7-information-outline"></i> <span>  المهمات </span></a></li>
                    <li><a href="{{route('statistic.index')}}" class="waves-effect"><i class="ion-ios7-information-outline"></i> <span>  الاحصائيات </span></a></li>
                </ul>
